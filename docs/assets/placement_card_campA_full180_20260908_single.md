# Placement mat (single sheet) -- operation card (campA_full180_20260908)
...
3. Lay the sheet on the table. Align the bold near-edge line to the FRONT TIPS
   of BOTH C-arms at once (5.9 cm apart) -- touching both fixes forward
...
5. One-time: with a ruler, mark every point (t1, o1, c1 ...) as a small cross +
   its short id. Cross-check a few against placement_label_map_campA_full180_20260908.csv.
