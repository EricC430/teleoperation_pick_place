...
🔴 **但模擬的手臂完全不在畫面裡，真實影片裡它清楚地從右上方伸進來夾杯子。**
相機既然已經對了，**手臂消失本身就是關節零位偏移的症狀**：它被抬高約 26 cm，超出這個
11 cm 高、俯角 10° 的相機視野。**這等於把相機變成一個靈敏的偏移偵測器——偏移量對了，手臂會自己出現。**
這也是目前最好的驗收方式：不必量 TCP 距離，看手臂在不在畫面裡就知道。
