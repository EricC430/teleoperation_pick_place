...
| S5 | `S5_sim_replay_augmentation.md` | `scripts/sim_replay_augment.py` | ❌ 不用（重播既有真實錄製，非即時） | 🟡 **2026-09-15 提議中，尚未裁決**（`[AI提議]`）。技術上無硬阻塞——§2 的四個缺口沒有一個卡住開工，只有缺口 4（相機幾何）需要 lab day 且可延後/外包 |
