...
| `plugins/` | Project LeRobot plugins, installed editable (see `docs/environment.md`): `lerobot_camera_uvc` (camera `type: opencv_uvc` = OpenCV + exposure / gain / white balance, D022) and `lerobot_robot_config_record` (writes `config_records/`). |
